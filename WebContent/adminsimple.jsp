...
<body>
<input type="button" value="Pupitre 4" style="color: black;" onclick="document.forms['myform'].servername.value=this.alt" alt="lg-p4">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="Pupitre 3" style="color: black;" onclick="document.forms['myform'].servername.value=this.alt" alt="lg-p3">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="Pupitre 2" style="color: black;" onclick="document.forms['myform'].servername.value=this.alt" alt="lg-p2">
<br/><br/>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value="Pupitre 1" style="color: black;" onclick="document.forms['myform'].servername.value=this.alt" alt="lg-p1">
<form target="_self" name="myform">
  Selection <input name="servername" style="color: red" /><br/>
  <input type="hidden" name="gui" value="simple">
  ...
  <input type="submit" name="action" value="3 #Premier choix#" style="color: blue;">
  ...
  <input type="submit" name="action" value="6 #Deuxieme choix#" style="color: fuchsia;">
</form>
</body>
</html>