...
if (x == 1 && (y >=0 && y<=3)) { // put legend on the screens identified here
  int cutPosition = 0;
  if (y == 1)
    cutPosition = 1080;
  else if (y == 2)
...
%>
				<ScreenOverlay targetId="ballonOverlay">
				  ...
				  <Icon>
				    <href>http://lg-head/img/<%=request.getAttribute("marker_id")%>_dalle_01.jpg</href>
				  </Icon>
				  <overlayXY x="0" y="<%= cutPosition%>" xunits="pixels" yunits="pixels"/>
